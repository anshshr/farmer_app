                ...
                onPressed: () async {
                  try {
                    ...
                    var soilper = await getSoilPercentage(
                      ...
                      double.tryParse(soilData['temperature'].toString()) ?? 0,
                      rainfall,
                      humidity,
                      cropName.text,
                    );
                    ...
                    setState(() {
                      ...
                      phosphorus =
                          ...
                          0;
                      nitrogen =
                          double.tryParse(soilData['nitrogen'].toString()) ?? 0;
                      humidity =
                          double.tryParse(soilData['humidity'].toString()) ?? 0;
                      rainfall =
                          double.tryParse(soilData['rainfall'].toString()) ?? 0;
                    });
                  } catch (e) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
